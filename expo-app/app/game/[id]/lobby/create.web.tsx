...
const s = StyleSheet.create({
  ...
  subtitle: { color: '#34C759', fontSize: 18, fontWeight: '600', textAlign: 'center', marginBottom: 8 },
  hint: { color: 'rgba(255,255,255,0.5)', fontSize: 14, textAlign: 'center', marginBottom: 32 },
