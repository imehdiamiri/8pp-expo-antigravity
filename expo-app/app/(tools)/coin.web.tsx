...
const styles = StyleSheet.create({
  ...
  coinText: { color: '#FFCC00', fontSize: 14, fontWeight: '800', letterSpacing: 2, marginTop: 8 },
  ...
  statValue: { color: 'white', fontSize: 32, fontWeight: '800' },
  ...
  flipBtnText: { color: '#000', fontSize: 18, fontWeight: '700' },
});
