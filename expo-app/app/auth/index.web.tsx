...
const styles = StyleSheet.create({
  ...
  title: { color: 'white', fontSize: 32, fontWeight: '800', textAlign: 'center', marginBottom: 8 },
  ...
  toggleLeft: { color: 'rgba(255,255,255,0.5)', fontSize: 14 },
  toggleRight: { color: '#5AC8FA', fontSize: 14, fontWeight: '600' },
