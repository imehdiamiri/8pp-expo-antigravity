...
const st = StyleSheet.create({
  ...
  conceptTx:{color:'#FFCC00',fontSize:36,fontWeight:'800'},
  ...
  judgeAnswer:{color:'rgba(255,255,255,0.7)',fontSize:14,marginTop:2},
  ...
  rankScore:{color:'#FF9500',fontSize:18,fontWeight:'bold'},
});
