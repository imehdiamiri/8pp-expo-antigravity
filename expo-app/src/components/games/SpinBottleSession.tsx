...
const st = StyleSheet.create({
  ...
  bannerLabel: { color: 'rgba(255,255,255,0.45)', fontSize: 10, fontWeight: '700', letterSpacing: 1 },
  ...
  playerNodeTx: { color: 'rgba(255,255,255,0.85)', fontSize: 14, fontWeight: '600', maxWidth: 90 },
  ...
  promptTx: { color: '#fff', fontSize: 24, fontWeight: 'bold', textAlign: 'center', lineHeight: 34 },
